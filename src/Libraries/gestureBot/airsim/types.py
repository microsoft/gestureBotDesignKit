...
class RobotPose(MsgpackMixin):
    ...
    def __init__(self, fDuration = 0.0, fNeck = 0.0, fHead = 0.0, fLShoulder = 0.0, fLUpperArm = 0.0, fLElbow = 0.0, fLHand = 0.0, fRShoulder = 0.0, fRUpperArm = 0.0, fRElbow = 0.0, fRHand = 0.0):
        self.fDuration = fDuration

        self.fNeck = fNeck
        self.fHead = fHead

        self.fLShoulder = fLShoulder
        self.fLUpperArm = fLUpperArm
        self.fLElbow = fLElbow
        self.fLHand = fLHand

        self.fRShoulder = fRShoulder
        self.fRUpperArm = fRUpperArm
        self.fRElbow = fRElbow
        self.fRHand = fRHand

class RobotControls(MsgpackMixin):
    throttle = 0.0
    steering = 0.0
    brake = 0.0
    handbrake = False
