...
//--------------------------------------------------------------------------------------------
App.prototype.setStaticElbow = function (val)
{
    if (this.msrabot)
        this.msrabot.setStaticElbow(val);
}
//--------------------------------------------------------------------------------------------
App.prototype.showHelpers = function (val)
{
    if (this.msrabot)
        this.msrabot.setShowHelpers(val);
}
//--------------------------------------------------------------------------------------------
...
App.prototype.initializeScene = function ()
{
    ...
    //
    // set up custom event used by msrabot modules
    ...
    document.addEventListener('doneInit', function (e) {
        if ((scope.msrabot != null) && (scope.msrabot.doneInitializing))
    ...
    if (this.msrabot != null) {
        ...
        this.msrabot.initialize(v, false);
    }
}
//--------------------------------------------------------------------------------------------
...
App.prototype.onWebSocketMessage = function (event)
{
    ...
    if (data.msgType == 'initialization') {
        ...
        if (this.msrabot) {
            this.msrabot.setServoTargets(data.servos);
            this.msrabot.setControllerInfo(data.status, data.pose);
        }
        ...
        if (this.msrabot)
            this.msrabot.setServoTargets(data.servos);
        this.msrabot.setControllerInfo(data.controller, data.pose);
...
{
    if (this.msrabot)
        this.msrabot.setServos(servos, setImmediately);
}
//--------------------------------------------------------------------------------------------
